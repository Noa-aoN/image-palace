...
ImagePalace は、作っているうちに「あれもできる」「これもあると面白い」と機能を広げてきました。
カード生成から始まり、棚・空間・関係図・検索・認証・課金まで、当初の MVP よりずっと大きなアプリになっています。

その反面、機能の開発に力を使いすぎて、LP やオンボーディングなど「初めて触る人への伝え方」は
まだ改善の余地があります。正直、LP を作ったところで少し力尽きました。

### いま（α版）

- 公開中。カードの生成・整理・空間配置・認証・課金など、主要な機能は動いています
- 利用規約・プライバシーポリシー・特定商取引法の表記を用意し、決済も本番で通しています
- 一部の機能は改善中で、初めて触る人への導線はこれからです

### 短期

- 初めてでも迷わない導線（オンボーディング・使い方・ヘルプ）
- 面白さがすぐ伝わる見せ方（LP と初見の体験）
- 「作る → 整理する → 思い出す」という学習体験の強化
- 試用しやすい入口（サンプルやデモ用の導線）とモバイル対応、体感速度の改善
- 使ってくれた人へのアンケートで、ほしい知識と詰まった場所を集める

### 中長期

- 画像生成モデルの選択肢を増やし、より安く使えるようにする
- BYOA（自分の API キーを使う方式）で、コストの上限を利用者側で決められるようにする
- 検索・関連付け・意味理解の強化
- 多言語対応、ネイティブアプリ化
