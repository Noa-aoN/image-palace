...
いまは機能の枠を増やす段階から、<strong>ちゃんと伝わって、主要な体験を気持ちよく使えるものに整える段階</strong>へ移りたいと思っています。

### いま：α版

主要機能は動き、課金を含めて本番環境で公開しています。

まずは新しい機能を増やすより、今ある体験の磨き込みを優先します。
...
目指しているのは、AI で画像を作るだけではなく、
**自分の知識そのものを視覚的な世界として育てられる場所です。**

- AI がカード同士の意味や関係を理解し、知識をつなげる
- 意味検索から、忘れていた知識や思わぬ関連へ辿り着ける
- 空間・位置・関係性そのものを、記憶の手がかりにする
- 学習履歴から、忘れそうな知識をちょうどよい頃に再提示する
- 作ったカード・キャンバス・空間を共有したり、他の人の知識を取り込んだりする
- 学習だけでなく、アイデア整理・創作・ゲーム的な使い方にも広げる
- 画像生成モデルや BYOA を選び、品質とコストを自分で調整できるようにする
