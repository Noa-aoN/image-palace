...
export const ARTICLES: Article[] = [
  {
    ...
    excerpt:
      '文字だけで覚えるより、絵と一緒に覚えるほうが記憶に残りやすい。「絵優位性効果」「二重符号化理論」「記憶の宮殿」など、イメージ化学習を支える研究知見と、それを IMAGE PALACE がどう活かしているかを紹介します。',
    date: '2026-07-21',
    readingMinutes: 6,
    tags: ['記憶', '認知科学', '学習法'],
    body: [
      ...
      { type: 'h2', text: 'IMAGE PALACE はこれをどう活かしているか' },
      {
        type: 'p',
        text: 'IMAGE PALACE は、これらの知見を日常の学習に落とし込むために生まれました。入力した単語や概念を、その意味を表すイメージに自動で変換し、「文字＋イメージ」のカードとして手元に残します。二重符号化を、手間なく実現するためのしくみです。',
      },
      {
        type: 'p',
        text: 'さらにボードでは、カードを空間に配置し、線でつないで関係を「地図」のように可視化できます。これは記憶の宮殿の発想に近く、単語どうしのつながりを、位置と視覚で覚える助けになります。',
      },
      {
        type: 'p',
        text: 'イメージは、記憶のいちばん古くて強い入り口です。その入り口を、誰でも手軽に使えるようにすること——それが IMAGE PALACE の目指すところです。',
      },
      { type: 'h2', text: 'まとめ' },
      {
        type: 'ul',
        items: [
          ...
          'IMAGE PALACE は「文字＋イメージ」のカードと空間配置で、これらを日常に取り入れる',
        ],
      },
    ],
    references: [
