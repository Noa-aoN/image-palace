...
export const ROOMS: Room[] = [
  ...
  { key: 'entrance', href: '/entrance', label: 'エントランス', desc: '情報石碑が立ち並ぶ玄関。ここからすべての場所へ', rect: { x: 114, y: 126, w: 132, h: 26 }, current: true },
]
...
export const COLUMNS: [number, number, number][] = [
  ...
  // 正面ポルチコ（玄関）：左右に2本ずつ。太さは中庭の柱に合わせる。
  [124, 143, 4], [148, 143, 4], [212, 143, 4], [236, 143, 4],
]
