...
export type RightPanelMode = 'closed' | 'card' | 'board-cards' | 'add-cards' | 'board-objects' | 'edge'
...
export const useRightPanelStore = create<RightPanelState>()((set) => ({
  ...
  close: () => set({ mode: 'closed', itemId: null, edge: null, focusItemId: null, pendingAddItem: null }),
