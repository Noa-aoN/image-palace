...
RSpec.describe Box, type: :model do
  ...
  describe "#cover_cards" do
    ...
    it "View エントリ（デッキ含む）はそのビューの表紙カードをカバー候補に含める" do
      ...
      box.box_entries.create!(entry_type: "View", entry_id: view.id)

      expect(box.cover_cards).to include(cover)
    end
  end
end
