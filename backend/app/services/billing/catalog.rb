...
module Billing
  ...
  module Catalog
    ...
    # 3 があるので、6ヶ月を超えないこと。
    #
    # 出どころで分けない。**どのクレジットも受け取りから6ヶ月**で揃える。
    # 以前は月額プランのぶんだけ「毎月まるごと失効」だった。これは
    #   - 払っている人ほど厳しい（無料枠は6ヶ月の期限付きで積まれる）という逆転で、
    #   - 利用規約の「有料プランで毎月付与されるクレジットも付与から6ヶ月」とも食い違っていた。
    # 溜まりうる上限は6ヶ月ぶんで頭打ちになるので、抱える原価は有界のまま。
