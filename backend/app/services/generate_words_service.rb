...
class GenerateWordsService
  ...
  SYSTEM_PROMPT = <<~PROMPT.freeze
    ...
    テーマが「ランダム」または空の場合は、分野を大きく横断して（科学・数学・歴史・芸術・哲学・言語・自然・技術・神話・音楽など）、
    あまり知られていない用語やマイナーな題材も積極的に織り交ぜ、意外性があり知的好奇心を刺激する、振り幅の大きい語彙を選んでください。
    ただし画像化しやすい具体的な名詞を優先し、抽象的すぎる概念は避けてください（道具・楽器・建造物・乗り物・場所・天体・歴史的遺物・装置・料理など）。
    動植物に偏りすぎないようにし、専門用語・固有名詞・雑学的な題材の比率を高めてください。
