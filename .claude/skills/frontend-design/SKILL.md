...
- **Branch Naming**: Format is `<type>/<issue-number>-<content>`. Do NOT use '#'.
- **PR Titles**: Format is `[#issue-number] Description`.
- **Tech Stack**: Backend is Rails 8 API. Frontend is Next.js (App Router) + Tailwind CSS + shadcn/ui.
- **Design Context**: "Image Palace" - A visual-rich, immersive palace-like elegance.
